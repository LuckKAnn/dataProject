...
import pickle
html = "https://top.news.sina.com.cn/ws/GetTopDataList.php?top_type=day&top_cat=news_world_suda&top_time={day}&top_show_num=100&top_order=DESC&short_title=1&js_var=hotNewsData"
...
FILE_NAME= "./tmp/dataWithTheme_international01.pkl"
def mainCrawl(day):
...
def CrawlDetail(new,day,save):
    try:
        ...
        if contents is not None:
            ...
            # 转载量: trans
            # 点赞量: like
            data = {'id': article_id, 'topic': article_topic, 'content': ans, 'time': day,'theme':"International"}
            save.append(data)
